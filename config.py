...
class Config(object):
    ...
    ALIVE_NAME = os.environ.get("Ꮢɪsʜᴀʙʜ★", None)
    # Get the values for following 2 from my.telegram.org
    APP_ID = int(os.environ.get("1817429", 6))
    API_HASH = os.environ.get("0032867a279f1803b6de52c3f829b5b6") or None
    ...
    STRING_SESSION = os.environ.get("1BVtsOK8Bu16uPY4JLb--m4CN5thYoDz0QBp4m6um-3NxsuPizuhnS9ZxYKZchlhm6mNjNVM4QEaBCHsZhYBWQWy4F1ENLuqwJwcLjjYcqOx16yv6NlszSSR93Drkn4hfwzzVDz7SBXBf2fWCllfHaGmevxvE_z8RytyaxXUZ4m4Vzw8rtLg03C0xpVBTHdK2eGP3xhWxBoxEYeL9NYYsZk0K2O9Xath-dDXC-qkHMU5ylkrkZsHUHDtmOLUFT9v4WeXs9KufnyUCqbtiZKfYdTsmuIV8rlUiiE-2gkipF30n4p-6fEwf35hKRO1zDMLZcQ1l6qkfJ3BauEW49iUT9zvaiLQ1rc4=", None)
    # Telegram BOT Token and bot username from @BotFather
    TG_BOT_TOKEN = os.environ.get("2047391714:AAFvTBUmzEkRUHvGaRy6e9UCgufLHpSGox4") or os.environ.get(
        "TG_BOT_TOKEN_BF_HER", None
    )
    TG_BOT_USERNAME = Bb_AlpHa_xD_bot
    ...
    PRIVATE_GROUP_BOT_API_ID = int(os.environ.get("-1001551399136") or 0)
    # Set this value same as PRIVATE_GROUP_BOT_API_ID if you need pmgaurd
    PRIVATE_GROUP_ID = int(os.environ.get("-1001551399136") or 0)
    # Set this value for working of fban/unfban/superfban/superunfban cmd
    FBAN_GROUP_ID = int(os.environ.get("-1001551399136") or 0)
    # set this value with channel id of private channel use full for .frwd cmd
    PRIVATE_CHANNEL_BOT_API_ID = int(os.environ.get("-1001551399136") or 0)
    ...
    PM_LOGGER_GROUP_ID = int(
        ...
        or os.environ.get("-1001551399136")
        or 0
    )
